// Safe Rust wrapper over biospy-usb-sys. RAII handles, typed errors, blocking I/O surface.
// Used by every backend in biospy-core::backends.

#![deny(unsafe_op_in_unsafe_fn)]

use biospy_usb_sys as sys;
